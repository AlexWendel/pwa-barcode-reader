...
})({"2XGYe":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "692d638c97bcf86e";
"use strict";
...
},{}],"8EFNI":[function(require,module,exports,__globalThis) {
...
class RelayService {
    constructor(url, roomId){
        this.url = url;
        this.roomId = roomId;
        this.clientId = (0, _uuidJs.getDeviceUUID)();
        this.websocket = null;
        this.onStatusChange = ()=>{};
        this.retryCount = 0;
        this.maxRetries = 5;
    ...
    connect() {
        ...
        this.websocket.onclose = ()=>{
            ...
            } else this.onStatusChange('error', 'Failed to connect to WebSocket after 5 attempts.');
        };
    ...
    sendData(data) {
        ...
        } else new Error('WebSocket is not open.');
    }
}
exports.default = RelayService;

},{"../utils/uuid.js":"dCPV6","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dCPV6":[function(require,module,exports,__globalThis) {
/**
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getDeviceUUID", ()=>getDeviceUUID);
...
},{}]},["2XGYe","8EFNI"], "8EFNI", "parcelRequirea202", {})

//# sourceMappingURL=barcode-scanner-main.97bcf86e.js.map
