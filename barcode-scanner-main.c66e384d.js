...
`,(class t extends HTMLElement{constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(g.content.cloneNode(!0))}connectedCallback(){this.setAttribute("slot","panel"),this.setAttribute("role","tabpanel"),this.setAttribute("hidden",""),this.id||(this.id=d("panel",(++p).toString()))}static defineCustomElement(e="a-tab-panel"){"u">typeof window&&!window.customElements.get(e)&&window.customElements.define(e,t)}}).defineCustomElement();var v={TOP:"top",BOTTOM:"bottom",START:"start",END:"end"},f={LTR:"ltr",RTL:"rtl"},y=Object.entries(v).map(([,t])=>t),w={AUTO:"auto",MANUAL:"manual"},E={DOWN:"ArrowDown",LEFT:"ArrowLeft",RIGHT:"ArrowRight",UP:"ArrowUp",HOME:"Home",END:"End",ENTER:"Enter",SPACE:" "},A=`
  :host {
  ...
  /* placement="top" */
  .tab-group,
  :host([placement="${v.TOP}"]) .tab-group {
    flex-direction: column;
  }

  /* placement="bottom" */
  :host([placement="${v.BOTTOM}"]) .tab-group {
    flex-direction: column;
  }

  :host([placement="${v.BOTTOM}"]) .tab-group__nav {
    order: 1;
  }

  /* placement="start" */
  :host([placement="${v.START}"]) .tab-group {
    flex-direction: row;
  }

  :host([placement="${v.START}"]) .tab-group__tabs {
    flex-direction: column;
    align-items: flex-start;
  }

  :host([placement="${v.START}"]) .tab-group__panels {
    flex: 1;
    padding: 0 1rem;
  }

  /* placement="end" */
  :host([placement="${v.END}"]) .tab-group {
    flex-direction: row;
  }

  :host([placement="${v.END}"]) .tab-group__nav {
    order: 1;
  }

  :host([placement="${v.END}"]) .tab-group__tabs {
    flex-direction: column;
    align-items: flex-start;
  }

  :host([placement="${v.END}"]) .tab-group__panels {
    flex: 1;
    padding: 0 1rem;
  }
...
`,(class t extends HTMLElement{#p=null;#r=null;#w=null;#s=void 0;#t=null;#k;static customAnimations;#e="api";constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(G.content.cloneNode(!0))}static get observedAttributes(){return["open","duration","close-label"]}attributeChangedCallback(t,e,o){if(!(!this.isConnected||e===o))switch(t){case"open":this.#A();break;case"duration":this.#i(),this.#h()&&this.#o();break;case"close-label":this.#m()}}get closable(){return this.hasAttribute("closable")}set closable(t){this.toggleAttribute("closable",!!t)}get open(){return this.hasAttribute("open")}set open(t){this.toggleAttribute("open",!!t)}get duration(){let t=this.getAttribute("duration");if(null===t)return 1/0;let e=Number(t);return Number.isNaN(e)?1/0:e}set duration(t){this.setAttribute("duration",null!=t?t.toString():t)}get variant(){return this.getAttribute("variant")||""}set variant(t){this.setAttribute("variant",t)}get closeLabel(){return this.getAttribute("close-label")||"Close"}set closeLabel(t){this.setAttribute("close-label",null!=t?t.toString():t)}get customAnimations(){return this.#k}set customAnimations(t){this.#k=t}connectedCallback(){this.#E("closable"),this.#E("open"),this.#E("duration"),this.#E("variant"),this.#E("closeLabel"),this.#E("customAnimations"),this.#p=this.shadowRoot?.querySelector(".alert")??null,this.#r=this.shadowRoot?.querySelector(".alert__close")??null,this.#w=this.shadowRoot?.querySelector('slot[name="close"]')??null,this.#r?.addEventListener("click",this.#d),this.#w?.addEventListener("slotchange",this.#u),this.addEventListener("mouseenter",this.#l),this.addEventListener("mouseleave",this.#n),this.addEventListener("command",this.#v),this.open?(this.#p?.removeAttribute("hidden"),this.#h()&&this.#o()):this.#p?.setAttribute("hidden",""),this.closeLabel&&this.#m()}disconnectedCallback(){this.#i(),this.#r?.removeEventListener("click",this.#d),this.#w?.removeEventListener("slotchange",this.#u),this.removeEventListener("mouseenter",this.#l),this.removeEventListener("mouseleave",this.#n),this.removeEventListener("command",this.#v)}#A(){this.#i(),this.open?(this.#h()&&this.#o(),this.#p?.removeAttribute("hidden"),this.#c("alert-show"),this.#y(this.#p)?.finished.finally(()=>{this.#c(V)})):(this.#c("alert-hide",{reason:this.#e}),this.#b(this.#p)?.finished.finally(()=>{this.#p?.setAttribute("hidden",""),this.#c(U,{reason:this.#e}),this.#e="api"}))}#i(){void 0!==this.#s&&(clearTimeout(this.#s),this.#s=void 0)}#o(){this.#s=window.setTimeout(()=>{this.#e="timeout",this.open=!1},this.duration)}#h(){return this.open&&this.duration!==1/0}#d=()=>{this.closable&&(this.#e="user",this.open=!1)};#l=()=>{this.#i()};#n=()=>{this.#i(),this.#h()&&this.#o()};#u=()=>{this.#m()};#v=t=>{switch(t.command){case"--alert-show":this.open=!0;break;case"--alert-hide":this.#e="api",this.open=!1}};#m(){this.#r&&((this.#w?.assignedElements()||[])?.some(t=>t.textContent?.replace(/\s/g,"")!=="")?this.#r.removeAttribute("aria-label"):this.#r.setAttribute("aria-label",this.closeLabel))}#x(){let e=window.matchMedia("(prefers-reduced-motion: reduce)").matches,o={show:{keyframes:[{opacity:0,transform:"scale(0.9)"},{opacity:1,transform:"scale(1)"}],options:{duration:250,easing:"ease"}},hide:{keyframes:[{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.9)"}],options:{duration:250,easing:"ease"}}},i=this.customAnimations||t.customAnimations||{},r=r=>{let s=i[r]?.options??{},a=o[r].options;return{...a,...s,duration:e||null===this.customAnimations||null===t.customAnimations?0:s.duration??a.duration}};return{show:{keyframes:i.show?.keyframes??o.show.keyframes,options:r("show")},hide:{keyframes:i.hide?.keyframes??o.hide.keyframes,options:r("hide")}}}#y(t){let{keyframes:e,options:o}=this.#x().show;return t?.animate(e,o)}#b(t){let{keyframes:e,options:o}=this.#x().hide;return t?.animate(e,o)}#c(t,e=null){let o=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});this.dispatchEvent(o)}#a(t,e){return new Promise(o=>{t.addEventListener(e,e=>{e.target===t&&o()},{once:!0})})}show(){return this.open?Promise.resolve():(this.open=!0,this.#a(this,V))}hide(){return this.open?(this.open=!1,this.#a(this,U)):Promise.resolve()}toast(t={}){if(t={forceRestart:!1,...t},this.#t){if(!t.forceRestart)return this.#t.promise;this.#t.resolve(),this.#t.cleanup()}let e=()=>{},o=new Promise(t=>e=t),i=()=>{this.#t?.resolve(),this.#t?.cleanup()};this.#t={promise:o,resolve:e,cleanup:()=>{this.removeEventListener(U,i),this.parentNode===W&&W.removeChild(this),W.querySelector(j)||W.remove(),this.open=!1,this.#t=null}},W.parentElement||document.body.append(W),W.appendChild(this),this.#p?.setAttribute("data-toast",""),this.open=!0;let r=W.shadowRoot?.querySelector(".stack");return r?.scrollTo({top:r.scrollHeight}),this.addEventListener(U,i,{once:!0}),o}#E(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(e=j){"u">typeof window&&!window.customElements.get(e)&&window.customElements.define(e,t)}}).defineCustomElement();const X="barcode-scanner/",J="settings",Q="history",tt=async t=>{try{return[null,await function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:K();return e("readonly",function(e){return Y(e.get(t))})}(t)]}catch(t){return[t,void 0]}},te=async(t,e)=>{try{return await function(t,e){var o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:K();return o("readwrite",function(o){return o.put(e,t),Y(o.transaction)})}(t,e),[null]}catch(t){return[t]}},to=async()=>tt(X+J),ti=async t=>te(X+J,t),tr=async()=>tt(X+Q),ts=async t=>te(X+Q,t),ta={info:(...t)=>{},error:(...t)=>{}};async function tn(t,e){if(!t||!e)return;let o=t.querySelector(`bs-result[value="${e}"]`);o&&o.remove();let i=document.createElement("bs-result");i.setAttribute("value",e),i.setAttribute("role","alert"),i.setAttribute("aria-live","assertive"),i.setAttribute("aria-atomic","true"),t.insertBefore(i,t.firstElementChild),t.scrollTop=0}const tl=(()=>{let t=new(window.AudioContext||window.webkitAudioContext||window.audioContext);if(t)return e=>{let{duration:o,frequency:i,volume:r,type:s,onEnded:a}=e,n=t.createOscillator(),l=t.createGain();n.connect(l),l.connect(t.destination),r&&(l.gain.value=r),i&&(n.frequency.value=i),s&&(n.type=s),"function"==typeof a&&(n.onended=a),n.start(t.currentTime),n.stop(t.currentTime+(o||500)/1e3)}})();async function td(t=0){if("function"==typeof window.navigator.vibrate)try{window.navigator.vibrate(t)}catch{}}let tc=0;async function th(t={}){let{success:e=!0}=t,[,o]=await to();if(!o)return;let i=Date.now();i-tc<1e3||(o.beep&&tl(e?{duration:200,frequency:860,volume:.03,type:"square"}:{duration:300,frequency:200,volume:.05,type:"sawtooth"}),o.vibrate&&td(e?100:200),tc=i)}function tu(t,e){if(!t||!e)return;let o=t.getBoundingClientRect(),i=.9*o.width,r=.5*o.height;e.style.cssText=`width: ${i}px; height: ${r}px`}const tm=["aztec","code_128","code_39","code_93","codabar","data_matrix","ean_13","ean_8","itf","pdf417","qr_code","upc_a","upc_e"];class tp{static async polyfill(){if("BarcodeDetector"in window)ta.info("Using the native BarcodeDetector API.");else try{await n("3jPiW"),ta.info("Using BarcodeDetector polyfill.")}catch(t){throw Error("BarcodeDetector API is not supported by your browser.",{cause:t})}}static async getSupportedFormats(){let t=await window.BarcodeDetector.getSupportedFormats()||[];return tm.filter(e=>t.includes(e))}static async create(t){let e=Array.isArray(t)&&t.length>0?t:await tp.getSupportedFormats();return new tp(e)}static async setup(){try{return await tp.polyfill(),{barcodeReaderError:null}}catch(t){return{barcodeReaderError:t}}}constructor(t){this.barcodeReader=new window.BarcodeDetector({formats:t})}async detect(t){if(!this.barcodeReader)throw Error("BarcodeReader is not initialized.");let e=await this.barcodeReader.detect(t);if(Array.isArray(e)&&e.length>0){let t=e[0];return ta.info({rawValue:t.rawValue,format:t.format}),t}throw Error("Could not detect barcode from provided source.")}}function tb(t={}){let{el:e,isTorchOn:o}={...{el:document.getElementById("torchButton"),isTorchOn:!1},...t},i=e.querySelectorAll("svg path");2===i.length&&(i[0].style.display=o?"none":"block",i[1].style.display=o?"block":"none",e.setAttribute("aria-label",`Turn ${o?"off":"on"} flash`))}const tg="video-capture",tv=`
...
`;class ty extends HTMLElement{#L={};#C=null;#_=null;constructor(){super(),this.#L=this.getSupportedConstraints(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tf.content.cloneNode(!0))}static get observedAttributes(){return["no-image","pan","tilt","zoom","torch"]}attributeChangedCallback(t,e,o){if(!this.isConnected)return;let i=this.getTrackCapabilities();if("zoom"===t&&e!==o&&"zoom"in this.#L){let t=!!("zoom"in i&&i.zoom?.min&&i.zoom?.max)&&this.zoom>=i.zoom.min&&this.zoom<=i.zoom.max;"number"==typeof this.zoom&&t&&this.#S("zoom",this.zoom)}"torch"===t&&e!==o&&"torch"in this.#L&&this.#S("torch",this.torch)}async connectedCallback(){if(this.#z("autoPlay"),this.#z("facingMode"),this.#z("zoom"),this.#z("torch"),this.#_=this.shadowRoot?.querySelector("video")||null,this.#_?.addEventListener("loadedmetadata",this.#T),!ty.isSupported())return this.dispatchEvent(new CustomEvent(`${tg}:error`,{bubbles:!0,composed:!0,detail:{error:{name:"NotSupportedError",message:"Not supported"}}}));this.autoPlay&&this.startVideoStream()}disconnectedCallback(){this.stopVideoStream(),this.#_?.removeEventListener("loadedmetadata",this.#T)}get autoPlay(){return this.hasAttribute("auto-play")}set autoPlay(t){this.toggleAttribute("auto-play",!!t)}get facingMode(){let t=this.getAttribute("facing-mode");return"user"!==t?"environment":t}set facingMode(t){this.setAttribute("facing-mode",t)}get zoom(){return Number(this.getAttribute("zoom"))||1}set zoom(t){this.setAttribute("zoom",null!=t?t.toString():t)}get torch(){return this.hasAttribute("torch")}set torch(t){this.toggleAttribute("torch",!!t)}get loading(){return this.hasAttribute("loading")}#T=t=>{let e=t.target;e.play().then(()=>{this.dispatchEvent(new CustomEvent(`${tg}:video-play`,{bubbles:!0,composed:!0,detail:{video:e}}))}).catch(t=>{this.dispatchEvent(new CustomEvent(`${tg}:error`,{bubbles:!0,composed:!0,detail:{error:t}}))}).finally(()=>{this.removeAttribute("loading")})};#S(t,e){var o,i,r;if(!this.#C)return;let[s]=this.#C.getVideoTracks(),a=this.getTrackCapabilities(),n=this.getTrackSettings(),l="pan"===t||"tilt"===t||"zoom"===t?(o=Number(e),i=a[t]?.min||1,r=a[t]?.max||1,Number.isNaN(i)&&(i=0),Number.isNaN(r)&&(r=0),Math.min(Math.max(o,Math.min(i,r)),Math.max(i,r))):e;t in n&&s.applyConstraints({advanced:[{[t]:l}]}).catch(()=>{})}#z(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}async startVideoStream(t){if(!ty.isSupported()||this.#C)return;this.setAttribute("loading","");let e={video:{facingMode:{ideal:this.facingMode},pan:!0,tilt:!0,zoom:!0,torch:this.torch},audio:!1};if("string"==typeof t&&t.trim().length>0&&(e.video.deviceId={exact:t}),"string"==typeof this.cameraResolution&&this.cameraResolution.trim().length>0){let[t=0,o=0]=this.cameraResolution.split("x").map(t=>Number(t));t>0&&o>0&&(e.video.width=t,e.video.height=o)}try{this.#C=await navigator.mediaDevices.getUserMedia(e),this.#_&&(this.#_.srcObject=this.#C),this.#S("pan",this.pan),this.#S("tilt",this.tilt),this.#S("zoom",this.zoom)}catch(t){this.dispatchEvent(new CustomEvent(`${tg}:error`,{bubbles:!0,composed:!0,detail:{error:t}}))}finally{this.removeAttribute("loading")}}restartVideoStream(t){this.#C&&this.#_&&this.stopVideoStream(),this.startVideoStream(t)}stopVideoStream(){if(!this.#_||!this.#C)return;let[t]=this.#C.getVideoTracks();t?.stop(),this.#_.srcObject=null,this.#C=null}getSupportedConstraints(){return ty.isSupported()&&navigator.mediaDevices.getSupportedConstraints()||{}}getTrackCapabilities(){if(!this.#C)return{};let[t]=this.#C.getVideoTracks();return t&&"function"==typeof t.getCapabilities&&t.getCapabilities()||{}}getTrackSettings(){if(!this.#C)return{};let[t]=this.#C.getVideoTracks();return t&&"function"==typeof t.getSettings&&t.getSettings()||{}}static async getVideoInputDevices(){return navigator.mediaDevices&&navigator.mediaDevices.enumerateDevices?(await navigator.mediaDevices.enumerateDevices()||[]).filter(t=>"videoinput"===t.kind&&!!t.deviceId):[]}static isSupported(){return!!navigator.mediaDevices?.getUserMedia}static defineCustomElement(t=tg){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,ty)}}function tw(t,e={}){e={duration:5e3,variant:"neutral",icon:"",...e};let o={info:`
    ...
    `}[e.icon||e.variant]||"";return Object.assign(document.createElement("alert-element"),{closable:!0,duration:e.duration,variant:e.variant,innerHTML:`${o?`<span slot="icon">${o}</span>`:""}${e.trustDangerousInnerHTML?t:function(t){let e=document.createElement("div");return e.textContent=t,e.innerHTML}(t)}`}).toast()}var tE="clipboard-copy",tA="success",tx="error",tk=document.createElement("template"),tL=`
  :host([hidden]),
  [hidden],
  ::slotted([hidden]) {
    display: none !important;
...
`;class tM extends HTMLElement{constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tR.content.cloneNode(!0))}get value(){return this.getAttribute("value")}set value(t){this.setAttribute("value",t)}static get observedAttributes(){return["value"]}attributeChangedCallback(t,e,o){"value"===t&&e!==o&&this.#R(this.value)}connectedCallback(){if(this.#z("value"),window.matchMedia("(prefers-reduced-motion: no-preference)").matches){let t=this.shadowRoot.querySelector(".result");t?.animate([{backgroundColor:"var(--color-flash)"},{backgroundColor:"transparent"}],{duration:400,easing:"ease-out"})}if(!tS()){let t=this.shadowRoot.querySelector("web-share");t&&(t.hidden=!0)}}async #R(t){let e,o=this.shadowRoot.querySelector(".result"),i=o?.querySelector(".result__content"),r=o?.querySelector(".result__datetime"),s=o?.querySelector(".result__item");s&&s?.remove();try{let[,o]=await to();new URL(t),(e=document.createElement("a")).href=t,o?.openWebPageSameTab||(e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")),o?.openWebPage?e.click():window.requestAnimationFrame(()=>e.focus())}catch{e=document.createElement("span")}e.className="result__item",e.part="result__item",e.textContent=t,r.textContent=tz.format(new Date),i?.insertBefore(e,r);let a=o?.querySelector("custom-clipboard-copy"),n=o?.querySelector("web-share");if(a){let e=a.shadowRoot?.querySelector("button");a.setAttribute("value",t),e?.setAttribute("aria-label",`Copy to clipboard ${t}`),a.hidden=!1}if(n&&tS()){let e=n.querySelector("button");n.setAttribute("share-text",t),n.hidden=!1,e?.setAttribute("aria-label",`Share ${t}`)}}#z(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="bs-result"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tM)}}tM.defineCustomElement();class tq extends HTMLElement{#M=null;#q=null;#N=[];#O;constructor(){super()}get supportedFormats(){return this.#N}set supportedFormats(t){this.#N=t,this.#B()}async connectedCallback(){this.#z("supportedFormats"),this.#M=this.querySelector("#formatsList"),this.#q=this.querySelector("form");let[,t]=await to();this.#O=t??{},this.#q?.querySelectorAll('[name="general-settings"]').forEach(t=>{t.checked=this.#O[t.value]})}#B(){if(!this.#M)return;let t=this.#O?.formats;this.#M.replaceChildren(),this.supportedFormats.forEach(e=>{let o=document.createElement("li"),i=document.createElement("label"),r=document.createElement("input");r.type="checkbox",r.name="formats-settings",r.value=e,r.checked=null==t||t.includes(e),i.appendChild(r),i.appendChild(document.createTextNode(e)),o.appendChild(i),this.#M.appendChild(o)})}#z(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="bs-settings"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tq)}}tq.defineCustomElement();const tN=`
  :host {
...
`;class tB extends HTMLElement{#H=null;#D=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tO.content.cloneNode(!0))}async connectedCallback(){this.#H=this.shadowRoot?.getElementById("historyList"),this.#D=this.shadowRoot?.getElementById("emptyHistoryBtn"),this.#I((await tr())[1]||[]),this.#H?.addEventListener("click",this.#$),this.#D?.addEventListener("click",this.#P)}disconnectedCallback(){this.#H?.removeEventListener("click",this.#$),this.#D?.removeEventListener("click",this.#P)}async add(t){if(!t)return;let e={type:"add",message:"Error adding barcode to history"},[o,i=[]]=await tr();if(o||!Array.isArray(i))return this.#F("bs-history-error",e),o;if(i.find(e=>e===t))return;let r=[...i,t],[s]=await ts(r);return s?(ta.error("Error setting history",s),this.#F("bs-history-error",e),s):(this.#H?.insertBefore(this.#j(t),this.#H.firstElementChild),this.#F("bs-history-success",{type:"add",message:"Barcode added to history"}),null)}async remove(t){if(!t)return;let e={type:"remove",message:"Error removing barcode from history"},[o,i=[]]=await tr();if(o||!Array.isArray(i))return this.#F("bs-history-error",e),o;let r=i.filter(e=>e!==t),[s]=await ts(r);if(s)return ta.error("Error setting history",s),this.#F("bs-history-error",e),s;let a=this.#H?.querySelector(`li[data-value="${t}"]`);return a?.remove(),this.#F("bs-history-success",{type:"remove",message:"Barcode removed from history"}),null}async empty(){let[t]=await ts([]);return t?(ta.error("Error setting history",t),this.#F("bs-history-error",{type:"empty",message:"Error emptying history"}),t):(this.#H?.replaceChildren(),this.#F("bs-history-success",{type:"empty",message:"History emptied successfully"}),null)}#I(t){if(!this.#H)return;this.#H.replaceChildren();let e=document.createDocumentFragment();[...t].reverse().forEach(t=>e.appendChild(this.#j(t))),this.#H.appendChild(e)}#j(t){let e,o=document.createElement("li");o.setAttribute("data-value",t);try{new URL(t),(e=document.createElement("a")).href=t,e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")}catch{e=document.createElement("span")}e.textContent=t;let i=document.createElement("div");i.className="actions";let r=document.createElement("custom-clipboard-copy"),s=r.shadowRoot?.querySelector("button");r.setAttribute("only-icon",""),r.setAttribute("value",t),s?.setAttribute("aria-label",`Copy to clipboard ${t}`),i.appendChild(r);let a=document.createElement("button");return a.type="button",a.className="delete-action",a.setAttribute("data-action","delete"),a.setAttribute("aria-label",`Remove from history ${t}`),a.innerHTML=`
    ...
    `,i.appendChild(a),o.appendChild(e),o.appendChild(i),o}#$=async t=>{let e=t.target;if(e.closest('[data-action="delete"]')){let t=e.closest("li").dataset.value;window.confirm(`Delete history item ${t}?`)&&this.remove(t)}};#P=async()=>{window.confirm("Empty history? This action cannot be undone.")&&this.empty()};#F(t,e=null){let o=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});this.dispatchEvent(o)}static defineCustomElement(t="bs-history"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tB)}}tB.defineCustomElement(),async function(){let t=document.querySelector("video-capture"),e=document.querySelector("bs-settings"),o=document.querySelector("bs-history"),i=document.getElementById("cameraPanel"),r=i.querySelector(".results"),s=document.getElementById("scanInstructions"),a=document.getElementById("scanBtn"),n=document.querySelector("resize-observer"),d=document.getElementById("scanFrame"),c=document.getElementById("torchButton"),h=document.getElementById("globalActions"),u=document.getElementById("historyBtn"),m=document.getElementById("historyDialog"),p=document.getElementById("settingsBtn"),b=document.getElementById("settingsDialog"),g=document.getElementById("settingsForm"),v=document.getElementById("cameraSelect"),f=document.getElementById("connectionModal"),y=document.getElementById("connectionStatusText"),w=document.getElementById("loading-spinner"),E=document.getElementById("manual-code-input"),A=document.getElementById("send-manual-code"),x=null,k=!0,L=null,C=null,_=null,S=null;async function z(){let{barcodeReaderError:o}=await tp.setup();if(o){let t=document.getElementById("barcodeReaderError");k=!1,h?.setAttribute("hidden",""),t?.setAttribute("open","");return}let i=await tp.getSupportedFormats(),[,r]=await to(),s=r?.formats||i;C=await tp.create(s),t.addEventListener("video-capture:video-play",q,{once:!0}),t.addEventListener("video-capture:error",N,{once:!0}),ty.defineCustomElement();let l=t?.shadowRoot;_=l?.querySelector("video"),S=l?.querySelector('[part="actions-container"]'),e.supportedFormats=i,A.addEventListener("click",H),a.addEventListener("click",R),n.addEventListener("resize-observer:resize",M),p.addEventListener("click",O),g.addEventListener("change",function(t,e=0,o=!1){let i=null;if("function"!=typeof t)throw TypeError("Expected a function for first argument");return(...r)=>{clearTimeout(i),o&&!i&&t(...r),i=setTimeout(()=>{i=null,o||t(...r)},e)}}(B,500)),u.addEventListener("click",D),document.addEventListener("visibilitychange",P),document.addEventListener("keydown",F),document.addEventListener("bs-history-success",j),document.addEventListener("bs-history-error",V)}async function T(){if(k){ta.info("Scanning..."),s?.removeAttribute("hidden");try{let[,t]=await to(),e=await C.detect(_),i=e?.rawValue??"";if(!i)throw Error("No barcode detected");if(tn(r,i),L&&L.sendData(i),t?.addToHistory&&o?.add(i),th(),!t?.continueScanning){x&&(clearTimeout(x),x=null),a?.removeAttribute("hidden"),d?.setAttribute("hidden",""),S?.setAttribute("hidden","");return}}catch{}k&&(x=setTimeout(()=>T(),1e3))}}function R(){a?.setAttribute("hidden",""),d?.removeAttribute("hidden"),S?.removeAttribute("hidden"),T()}function M(){tu(t.shadowRoot.querySelector("video"),d)}async function q(e){d?.removeAttribute("hidden"),tu(e.detail.video,d),T();let o=e.target.getTrackSettings(),i=e.target.getTrackCapabilities(),r=document.getElementById("zoomLevel");if(i?.torch&&(c?.addEventListener("click",I),c?.removeAttribute("hidden"),t.hasAttribute("torch")&&tb({el:c,isTorchOn:!0})),o?.zoom&&i?.zoom){let e=document.getElementById("zoomControls"),s=i?.zoom?.min||0,a=i?.zoom?.max||10,n=o?.zoom||1;e?.addEventListener("click",e=>{let o=e.target.closest('[data-action="zoom-in"]'),i=e.target.closest('[data-action="zoom-out"]');o&&n<a&&(n+=.5),i&&n>s&&(n-=.5),r.textContent=n.toFixed(1),t.zoom=n}),e?.removeAttribute("hidden"),r.textContent=n.toFixed(1)}let s=await ty.getVideoInputDevices();s.forEach((t,e)=>{let o=document.createElement("option");o.value=t.deviceId,o.textContent=t.label||`Camera ${e+1}`,v.appendChild(o)}),s.length>1&&(v?.addEventListener("change",$),v?.removeAttribute("hidden"))}function N(t){let e=t.detail.error;if("NotFoundError"===e.name)return;let o="NotAllowedError"===e.name?"<strong>Error accessing camera</strong><br>Permission to use webcam was denied or video Autoplay is disabled. Reload the page to give appropriate permissions to webcam.":e.message;i.innerHTML=`
    ...
    `}function O(){b.open=!0}async function B(t){t.preventDefault();let e={},o=new FormData(g),i=o.getAll("general-settings"),r=o.getAll("formats-settings");i.forEach(t=>e[t]=!0),e.formats=r,ti(e),"formats-settings"===t.target.name&&(C=await tp.create(r))}function H(){console.log("Clicou");let t=document.getElementById("send-text"),e=document.getElementById("sending-spinner"),o=E.value;if(o){if(t.style.display="none",e.style.display="block",L)try{console.log("Sending code: "+o),L.sendData(o),th()}catch(t){console.error("Failed to send data:",t)}t.style.display="block",e.style.display="none"}}function D(){m.open=!0}function I(e){t.torch=!t.torch,tb({el:e.currentTarget,isTorchOn:t.hasAttribute("torch")})}function $(e){if("function"!=typeof t.restartVideoStream)return;let o=e.target.value||void 0;t.restartVideoStream(o)}function P(){if("hidden"===document.visibilityState)k=!1,null!=t&&"function"==typeof t.stopVideoStream&&t.stopVideoStream();else{k=!0;let t=document.querySelector("video-capture");if(!t)return;if(!t.loading&&a.hasAttribute("hidden")&&T(),"function"==typeof t.startVideoStream){let e=v?.value||void 0;t.startVideoStream(e)}}}function F(t){"Escape"===t.key&&function(){let t=!a.hidden,e=b.hasAttribute("open"),o=m.hasAttribute("open");t&&!(e||o)&&a.click()}()}function j(t){let{type:e,message:o}=t.detail;"add"===e&&tw(o,{variant:"success"})}function V(t){let{type:e,message:o}=t.detail;("remove"===e||"empty"===e)&&m?.hide(),tw(o,{variant:"danger"})}async function U(){let e=new URLSearchParams(window.location.search),o=e.get("ws_url"),i=e.get("room_id");if(!o||!i){y.textContent="URL incorreta! Tente novamente.",w.hidden=!0,f.hidden=!1;return}(L=new(0,l.default)(o,i)).onStatusChange=(e,o)=>{switch(e){case"connecting":y.textContent="Conectando ao servidor...",f.hidden=!1;break;case"authenticating":y.textContent="Autenticando...",f.hidden=!1;break;case"joining":y.textContent="Entrando na sala...",f.hidden=!1;break;case"connected":if(f.hidden=!0,C){if(k=!0,t&&"function"==typeof t.startVideoStream){let e=v?.value||void 0;t.startVideoStream(e)}T()}else z();break;case"reconnecting":y.textContent="Conexão perdida. Reconectando...",f.hidden=!1,k=!1,t&&"function"==typeof t.stopVideoStream&&t.stopVideoStream();break;case"disconnected":y.textContent="Desconectado do servidor.",f.hidden=!1,"function"==typeof t.stopVideoStream&&t.stopVideoStream();break;case"error":y.textContent=o||"Erro ao conectar ao servidor.",f.hidden=!1}},L.connect()}"function"==typeof HTMLDialogElement&&(h?.removeAttribute("hidden"),m?.removeAttribute("hidden"),b?.removeAttribute("hidden")),U()}();
//# sourceMappingURL=barcode-scanner-main.c66e384d.js.map
