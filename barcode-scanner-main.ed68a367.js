...
`,Z=document.createElement("template");function G(t){return new Promise(function(e,o){t.oncomplete=t.onsuccess=function(){return e(t.result)},t.onabort=t.onerror=function(){return o(t.error)}})}function Y(){var t,e,o,r;return i||(t="keyval-store",e="keyval",r=function(){if(o)return o;var i=indexedDB.open(t);return i.onupgradeneeded=function(){return i.result.createObjectStore(e)},(o=G(i)).then(function(t){t.onclose=function(){return o=void 0}},function(){}),o},i=function(t,o){return r().then(function(i){return o(i.transaction(e,t).objectStore(e))})}),i}Z.innerHTML=`
  <style>${W}</style>
...
`,(class t extends HTMLElement{#p=null;#r=null;#w=null;#s=void 0;#t=null;#k;static customAnimations;#e="api";constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(Z.content.cloneNode(!0))}static get observedAttributes(){return["open","duration","close-label"]}attributeChangedCallback(t,e,o){if(!(!this.isConnected||e===o))switch(t){case"open":this.#A();break;case"duration":this.#i(),this.#h()&&this.#o();break;case"close-label":this.#m()}}get closable(){return this.hasAttribute("closable")}set closable(t){this.toggleAttribute("closable",!!t)}get open(){return this.hasAttribute("open")}set open(t){this.toggleAttribute("open",!!t)}get duration(){let t=this.getAttribute("duration");if(null===t)return 1/0;let e=Number(t);return Number.isNaN(e)?1/0:e}set duration(t){this.setAttribute("duration",null!=t?t.toString():t)}get variant(){return this.getAttribute("variant")||""}set variant(t){this.setAttribute("variant",t)}get closeLabel(){return this.getAttribute("close-label")||"Close"}set closeLabel(t){this.setAttribute("close-label",null!=t?t.toString():t)}get customAnimations(){return this.#k}set customAnimations(t){this.#k=t}connectedCallback(){this.#E("closable"),this.#E("open"),this.#E("duration"),this.#E("variant"),this.#E("closeLabel"),this.#E("customAnimations"),this.#p=this.shadowRoot?.querySelector(".alert")??null,this.#r=this.shadowRoot?.querySelector(".alert__close")??null,this.#w=this.shadowRoot?.querySelector('slot[name="close"]')??null,this.#r?.addEventListener("click",this.#d),this.#w?.addEventListener("slotchange",this.#u),this.addEventListener("mouseenter",this.#l),this.addEventListener("mouseleave",this.#n),this.addEventListener("command",this.#v),this.open?(this.#p?.removeAttribute("hidden"),this.#h()&&this.#o()):this.#p?.setAttribute("hidden",""),this.closeLabel&&this.#m()}disconnectedCallback(){this.#i(),this.#r?.removeEventListener("click",this.#d),this.#w?.removeEventListener("slotchange",this.#u),this.removeEventListener("mouseenter",this.#l),this.removeEventListener("mouseleave",this.#n),this.removeEventListener("command",this.#v)}#A(){this.#i(),this.open?(this.#h()&&this.#o(),this.#p?.removeAttribute("hidden"),this.#c("alert-show"),this.#y(this.#p)?.finished.finally(()=>{this.#c(j)})):(this.#c("alert-hide",{reason:this.#e}),this.#b(this.#p)?.finished.finally(()=>{this.#p?.setAttribute("hidden",""),this.#c(V,{reason:this.#e}),this.#e="api"}))}#i(){void 0!==this.#s&&(clearTimeout(this.#s),this.#s=void 0)}#o(){this.#s=window.setTimeout(()=>{this.#e="timeout",this.open=!1},this.duration)}#h(){return this.open&&this.duration!==1/0}#d=()=>{this.closable&&(this.#e="user",this.open=!1)};#l=()=>{this.#i()};#n=()=>{this.#i(),this.#h()&&this.#o()};#u=()=>{this.#m()};#v=t=>{switch(t.command){case"--alert-show":this.open=!0;break;case"--alert-hide":this.#e="api",this.open=!1}};#m(){this.#r&&((this.#w?.assignedElements()||[])?.some(t=>t.textContent?.replace(/\s/g,"")!=="")?this.#r.removeAttribute("aria-label"):this.#r.setAttribute("aria-label",this.closeLabel))}#x(){let e=window.matchMedia("(prefers-reduced-motion: reduce)").matches,o={show:{keyframes:[{opacity:0,transform:"scale(0.9)"},{opacity:1,transform:"scale(1)"}],options:{duration:250,easing:"ease"}},hide:{keyframes:[{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.9)"}],options:{duration:250,easing:"ease"}}},i=this.customAnimations||t.customAnimations||{},r=r=>{let s=i[r]?.options??{},a=o[r].options;return{...a,...s,duration:e||null===this.customAnimations||null===t.customAnimations?0:s.duration??a.duration}};return{show:{keyframes:i.show?.keyframes??o.show.keyframes,options:r("show")},hide:{keyframes:i.hide?.keyframes??o.hide.keyframes,options:r("hide")}}}#y(t){let{keyframes:e,options:o}=this.#x().show;return t?.animate(e,o)}#b(t){let{keyframes:e,options:o}=this.#x().hide;return t?.animate(e,o)}#c(t,e=null){let o=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});this.dispatchEvent(o)}#a(t,e){return new Promise(o=>{t.addEventListener(e,e=>{e.target===t&&o()},{once:!0})})}show(){return this.open?Promise.resolve():(this.open=!0,this.#a(this,j))}hide(){return this.open?(this.open=!1,this.#a(this,V)):Promise.resolve()}toast(t={}){if(t={forceRestart:!1,...t},this.#t){if(!t.forceRestart)return this.#t.promise;this.#t.resolve(),this.#t.cleanup()}let e=()=>{},o=new Promise(t=>e=t),i=()=>{this.#t?.resolve(),this.#t?.cleanup()};this.#t={promise:o,resolve:e,cleanup:()=>{this.removeEventListener(V,i),this.parentNode===U&&U.removeChild(this),U.querySelector(F)||U.remove(),this.open=!1,this.#t=null}},U.parentElement||document.body.append(U),U.appendChild(this),this.#p?.setAttribute("data-toast",""),this.open=!0;let r=U.shadowRoot?.querySelector(".stack");return r?.scrollTo({top:r.scrollHeight}),this.addEventListener(V,i,{once:!0}),o}#E(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(e=F){"u">typeof window&&!window.customElements.get(e)&&window.customElements.define(e,t)}}).defineCustomElement();const J="barcode-scanner/",K="settings",X="history",Q=async t=>{try{return[null,await function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:Y();return e("readonly",function(e){return G(e.get(t))})}(t)]}catch(t){return[t,void 0]}},tt=async(t,e)=>{try{return await function(t,e){var o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:Y();return o("readwrite",function(o){return o.put(e,t),G(o.transaction)})}(t,e),[null]}catch(t){return[t]}},te=async()=>Q(J+K),to=async t=>tt(J+K,t),ti=async()=>Q(J+X),tr=async t=>tt(J+X,t),ts={info:(...t)=>{},error:(...t)=>{}};async function ta(t,e){if(!t||!e)return;let o=t.querySelector(`bs-result[value="${e}"]`);o&&o.remove();let i=document.createElement("bs-result");i.setAttribute("value",e),i.setAttribute("role","alert"),i.setAttribute("aria-live","assertive"),i.setAttribute("aria-atomic","true"),t.insertBefore(i,t.firstElementChild),t.scrollTop=0}const tn=(()=>{let t=new(window.AudioContext||window.webkitAudioContext||window.audioContext);if(t)return e=>{let{duration:o,frequency:i,volume:r,type:s,onEnded:a}=e,n=t.createOscillator(),l=t.createGain();n.connect(l),l.connect(t.destination),r&&(l.gain.value=r),i&&(n.frequency.value=i),s&&(n.type=s),"function"==typeof a&&(n.onended=a),n.start(t.currentTime),n.stop(t.currentTime+(o||500)/1e3)}})();async function tl(t=0){if("function"==typeof window.navigator.vibrate)try{window.navigator.vibrate(t)}catch{}}let td=0;async function tc(t={}){let{success:e=!0}=t,[,o]=await te();if(!o)return;let i=Date.now();i-td<1e3||(o.beep&&tn(e?{duration:200,frequency:860,volume:.03,type:"square"}:{duration:300,frequency:200,volume:.05,type:"sawtooth"}),o.vibrate&&tl(e?100:200),td=i)}function th(t,e){if(!t||!e)return;let o=t.getBoundingClientRect();e.style.cssText=`width: ${o.width}px; height: ${o.height}px`}const tu=["aztec","code_128","code_39","code_93","codabar","data_matrix","ean_13","ean_8","itf","pdf417","qr_code","upc_a","upc_e"];class tm{static async polyfill(){if("BarcodeDetector"in window)ts.info("Using the native BarcodeDetector API.");else try{await n("3jPiW"),ts.info("Using BarcodeDetector polyfill.")}catch(t){throw Error("BarcodeDetector API is not supported by your browser.",{cause:t})}}static async getSupportedFormats(){let t=await window.BarcodeDetector.getSupportedFormats()||[];return tu.filter(e=>t.includes(e))}static async create(t){let e=Array.isArray(t)&&t.length>0?t:await tm.getSupportedFormats();return new tm(e)}static async setup(){try{return await tm.polyfill(),{barcodeReaderError:null}}catch(t){return{barcodeReaderError:t}}}constructor(t){this.barcodeReader=new window.BarcodeDetector({formats:t})}async detect(t){if(!this.barcodeReader)throw Error("BarcodeReader is not initialized.");let e=await this.barcodeReader.detect(t);if(Array.isArray(e)&&e.length>0){let t=e[0];return ts.info({rawValue:t.rawValue,format:t.format}),t}throw Error("Could not detect barcode from provided source.")}}function tp(t={}){let{el:e,isTorchOn:o}={...{el:document.getElementById("torchButton"),isTorchOn:!1},...t},i=e.querySelectorAll("svg path");2===i.length&&(i[0].style.display=o?"none":"block",i[1].style.display=o?"block":"none",e.setAttribute("aria-label",`Turn ${o?"off":"on"} flash`))}function tb(t,e={}){e={duration:5e3,variant:"neutral",icon:"",...e};let o={info:`
    ...
    `}[e.icon||e.variant]||"";return Object.assign(document.createElement("alert-element"),{closable:!0,duration:e.duration,variant:e.variant,innerHTML:`${o?`<span slot="icon">${o}</span>`:""}${e.trustDangerousInnerHTML?t:function(t){let e=document.createElement("div");return e.textContent=t,e.innerHTML}(t)}`}).toast()}const tg="video-capture",tv=`
...
`;class tR extends HTMLElement{constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tT.content.cloneNode(!0))}get value(){return this.getAttribute("value")}set value(t){this.setAttribute("value",t)}static get observedAttributes(){return["value"]}attributeChangedCallback(t,e,o){"value"===t&&e!==o&&this.#R(this.value)}connectedCallback(){if(this.#z("value"),window.matchMedia("(prefers-reduced-motion: no-preference)").matches){let t=this.shadowRoot.querySelector(".result");t?.animate([{backgroundColor:"var(--color-flash)"},{backgroundColor:"transparent"}],{duration:400,easing:"ease-out"})}if(!t_()){let t=this.shadowRoot.querySelector("web-share");t&&(t.hidden=!0)}}async #R(t){let e,o=this.shadowRoot.querySelector(".result"),i=o?.querySelector(".result__content"),r=o?.querySelector(".result__datetime"),s=o?.querySelector(".result__item");s&&s?.remove();try{let[,o]=await te();new URL(t),(e=document.createElement("a")).href=t,o?.openWebPageSameTab||(e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")),o?.openWebPage?e.click():window.requestAnimationFrame(()=>e.focus())}catch{e=document.createElement("span")}e.className="result__item",e.part="result__item",e.textContent=t,r.textContent=tS.format(new Date),i?.insertBefore(e,r);let a=o?.querySelector("custom-clipboard-copy"),n=o?.querySelector("web-share");if(a){let e=a.shadowRoot?.querySelector("button");a.setAttribute("value",t),e?.setAttribute("aria-label",`Copy to clipboard ${t}`),a.hidden=!1}if(n&&t_()){let e=n.querySelector("button");n.setAttribute("share-text",t),n.hidden=!1,e?.setAttribute("aria-label",`Share ${t}`)}}#z(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="bs-result"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tR)}}tR.defineCustomElement();class tM extends HTMLElement{#M=null;#q=null;#O=[];#N;constructor(){super()}get supportedFormats(){return this.#O}set supportedFormats(t){this.#O=t,this.#H()}async connectedCallback(){this.#z("supportedFormats"),this.#M=this.querySelector("#formatsList"),this.#q=this.querySelector("form");let[,t]=await te();this.#N=t??{},this.#q?.querySelectorAll('[name="general-settings"]').forEach(t=>{t.checked=this.#N[t.value]})}#H(){if(!this.#M)return;let t=this.#N?.formats;this.#M.replaceChildren(),this.supportedFormats.forEach(e=>{let o=document.createElement("li"),i=document.createElement("label"),r=document.createElement("input");r.type="checkbox",r.name="formats-settings",r.value=e,r.checked=null==t||t.includes(e),i.appendChild(r),i.appendChild(document.createTextNode(e)),o.appendChild(i),this.#M.appendChild(o)})}#z(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="bs-settings"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tM)}}tM.defineCustomElement();const tq=`
  :host {
...
`;class tN extends HTMLElement{#B=null;#$=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tO.content.cloneNode(!0))}async connectedCallback(){this.#B=this.shadowRoot?.getElementById("historyList"),this.#$=this.shadowRoot?.getElementById("emptyHistoryBtn"),this.#D((await ti())[1]||[]),this.#B?.addEventListener("click",this.#P),this.#$?.addEventListener("click",this.#I)}disconnectedCallback(){this.#B?.removeEventListener("click",this.#P),this.#$?.removeEventListener("click",this.#I)}async add(t){if(!t)return;let e={type:"add",message:"Error adding barcode to history"},[o,i=[]]=await ti();if(o||!Array.isArray(i))return this.#F("bs-history-error",e),o;if(i.find(e=>e===t))return;let r=[...i,t],[s]=await tr(r);return s?(ts.error("Error setting history",s),this.#F("bs-history-error",e),s):(this.#B?.insertBefore(this.#j(t),this.#B.firstElementChild),this.#F("bs-history-success",{type:"add",message:"Barcode added to history"}),null)}async remove(t){if(!t)return;let e={type:"remove",message:"Error removing barcode from history"},[o,i=[]]=await ti();if(o||!Array.isArray(i))return this.#F("bs-history-error",e),o;let r=i.filter(e=>e!==t),[s]=await tr(r);if(s)return ts.error("Error setting history",s),this.#F("bs-history-error",e),s;let a=this.#B?.querySelector(`li[data-value="${t}"]`);return a?.remove(),this.#F("bs-history-success",{type:"remove",message:"Barcode removed from history"}),null}async empty(){let[t]=await tr([]);return t?(ts.error("Error setting history",t),this.#F("bs-history-error",{type:"empty",message:"Error emptying history"}),t):(this.#B?.replaceChildren(),this.#F("bs-history-success",{type:"empty",message:"History emptied successfully"}),null)}#D(t){if(!this.#B)return;this.#B.replaceChildren();let e=document.createDocumentFragment();[...t].reverse().forEach(t=>e.appendChild(this.#j(t))),this.#B.appendChild(e)}#j(t){let e,o=document.createElement("li");o.setAttribute("data-value",t);try{new URL(t),(e=document.createElement("a")).href=t,e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")}catch{e=document.createElement("span")}e.textContent=t;let i=document.createElement("div");i.className="actions";let r=document.createElement("custom-clipboard-copy"),s=r.shadowRoot?.querySelector("button");r.setAttribute("only-icon",""),r.setAttribute("value",t),s?.setAttribute("aria-label",`Copy to clipboard ${t}`),i.appendChild(r);let a=document.createElement("button");return a.type="button",a.className="delete-action",a.setAttribute("data-action","delete"),a.setAttribute("aria-label",`Remove from history ${t}`),a.innerHTML=`
    ...
    `,i.appendChild(a),o.appendChild(e),o.appendChild(i),o}#P=async t=>{let e=t.target;if(e.closest('[data-action="delete"]')){let t=e.closest("li").dataset.value;window.confirm(`Delete history item ${t}?`)&&this.remove(t)}};#I=async()=>{window.confirm("Empty history? This action cannot be undone.")&&this.empty()};#F(t,e=null){let o=new CustomEvent(t,{bubbles:!0,composed:!0,detail:e});this.dispatchEvent(o)}static defineCustomElement(t="bs-history"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tN)}}tN.defineCustomElement(),async function(){let t=document.querySelector("video-capture"),e=document.querySelector("bs-settings"),o=document.querySelector("bs-history"),i=document.getElementById("cameraPanel"),r=i.querySelector(".results"),s=document.getElementById("scanInstructions"),a=document.getElementById("scanBtn"),n=document.querySelector("resize-observer"),l=document.getElementById("scanFrame"),d=document.getElementById("torchButton"),c=document.getElementById("globalActions"),h=document.getElementById("historyBtn"),u=document.getElementById("historyDialog"),m=document.getElementById("settingsBtn"),p=document.getElementById("settingsDialog"),b=document.getElementById("settingsForm"),g=document.getElementById("cameraSelect"),v=null,f=!0,y=navigator.userAgent,w="WebDevice";/Windows/.test(y)?w="Windows":/Mac/.test(y)?w="Mac":/Linux/.test(y)?w="Linux":/Android/.test(y)?w="Android":/iPhone|iPad|iPod/.test(y)&&(w="iOS"),/Chrome/.test(y)?w+="-Chrome":/Firefox/.test(y)?w+="-Firefox":/Safari/.test(y)&&!/Chrome/.test(y)&&(w+="-Safari"),w+="-"+Math.floor(1e3*Math.random());let E=new URLSearchParams(window.location.search),A=E.get("ws_host")||"localhost",x=E.get("ws_port")||"8765",k=`ws://${A}:${x}`;console.log("Connecting to websocket...");let L=new WebSocket(k);L.addEventListener("open",function(){console.log("Connected to Python receiver"),L.send(JSON.stringify({type:"register",name:w}))}),L.addEventListener("close",function(){console.log("Closing websocket connection...")}),"function"==typeof HTMLDialogElement&&(c?.removeAttribute("hidden"),u?.removeAttribute("hidden"),p?.removeAttribute("hidden"));let{barcodeReaderError:C}=await tm.setup();if(C){let t=document.getElementById("barcodeReaderError");f=!1,c?.setAttribute("hidden",""),t?.setAttribute("open","");return}let _=await tm.getSupportedFormats(),[,S]=await te(),z=S?.formats||_,T=await tm.create(z);t.addEventListener("video-capture:video-play",N,{once:!0}),t.addEventListener("video-capture:error",function(t){let e=t.detail.error;if("NotFoundError"===e.name)return;let o="NotAllowedError"===e.name?"<strong>Error accessing camera</strong><br>Permission to use webcam was denied or video Autoplay is disabled. Reload the page to give appropriate permissions to webcam.":e.message;i.innerHTML=`
    ...
    `},{once:!0}),ty.defineCustomElement();let R=t?.shadowRoot,M=R?.querySelector("video"),q=R?.querySelector('[part="actions-container"]');async function O(){if(f){ts.info("Scanning..."),s?.removeAttribute("hidden");try{let[,t]=await te(),e=await T.detect(M),i=e?.rawValue??"";if(!i)throw Error("No barcode detected");if(ta(r,i),L.send(JSON.stringify({type:"barcode",code:i})),t?.addToHistory&&o?.add(i),tc(),!t?.continueScanning){v&&(clearTimeout(v),v=null),a?.removeAttribute("hidden"),l?.setAttribute("hidden",""),q?.setAttribute("hidden","");return}}catch{}f&&(v=setTimeout(()=>O(),1e3))}}async function N(e){l?.removeAttribute("hidden"),th(e.detail.video,l),O();let o=e.target.getTrackSettings(),i=e.target.getTrackCapabilities(),r=document.getElementById("zoomLevel");if(i?.torch&&(d?.addEventListener("click",B),d?.removeAttribute("hidden"),t.hasAttribute("torch")&&tp({el:d,isTorchOn:!0})),o?.zoom&&i?.zoom){let e=document.getElementById("zoomControls"),s=i?.zoom?.min||0,a=i?.zoom?.max||10,n=o?.zoom||1;e?.addEventListener("click",e=>{let o=e.target.closest('[data-action="zoom-in"]'),i=e.target.closest('[data-action="zoom-out"]');o&&n<a&&(n+=.5),i&&n>s&&(n-=.5),r.textContent=n.toFixed(1),t.zoom=n}),e?.removeAttribute("hidden"),r.textContent=n.toFixed(1)}let s=await ty.getVideoInputDevices();s.forEach((t,e)=>{let o=document.createElement("option");o.value=t.deviceId,o.textContent=t.label||`Camera ${e+1}`,g.appendChild(o)}),s.length>1&&(g?.addEventListener("change",$),g?.removeAttribute("hidden"))}async function H(t){t.preventDefault();let e={},o=new FormData(b),i=o.getAll("general-settings"),r=o.getAll("formats-settings");i.forEach(t=>e[t]=!0),e.formats=r,to(e),"formats-settings"===t.target.name&&(T=await tm.create(r))}function B(e){t.torch=!t.torch,tp({el:e.currentTarget,isTorchOn:t.hasAttribute("torch")})}function $(e){if("function"!=typeof t.restartVideoStream)return;let o=e.target.value||void 0;t.restartVideoStream(o)}e.supportedFormats=_,a.addEventListener("click",function(){a?.setAttribute("hidden",""),l?.removeAttribute("hidden"),q?.removeAttribute("hidden"),O()}),n.addEventListener("resize-observer:resize",function(){th(t.shadowRoot.querySelector("video"),l)}),m.addEventListener("click",function(){p.open=!0}),b.addEventListener("change",function(t,e=0,o=!1){let i=null;if("function"!=typeof t)throw TypeError("Expected a function for first argument");return(...r)=>{clearTimeout(i),o&&!i&&t(...r),i=setTimeout(()=>{i=null,o||t(...r)},e)}}(H,500)),h.addEventListener("click",function(){u.open=!0}),document.addEventListener("visibilitychange",function(){if("hidden"===document.visibilityState)f=!1,null!=t&&"function"==typeof t.stopVideoStream&&t.stopVideoStream();else{f=!0;let t=document.querySelector("video-capture");if(!t)return;if(!t.loading&&a.hasAttribute("hidden")&&O(),"function"==typeof t.startVideoStream){let e=g?.value||void 0;t.startVideoStream(e)}}}),document.addEventListener("keydown",function(t){"Escape"===t.key&&function(){let t=!a.hidden,e=p.hasAttribute("open"),o=u.hasAttribute("open");t&&!(e||o)&&a.click()}()}),document.addEventListener("bs-history-success",function(t){let{type:e,message:o}=t.detail;"add"===e&&tb(o,{variant:"success"})}),document.addEventListener("bs-history-error",function(t){let{type:e,message:o}=t.detail;("remove"===e||"empty"===e)&&u?.hide(),tb(o,{variant:"danger"})})}();
//# sourceMappingURL=barcode-scanner-main.ed68a367.js.map
